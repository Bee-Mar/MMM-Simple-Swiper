...
** MMM-Simple-Swiper
   #+BEGIN_SRC sh
     ...
     # installing dependencies retrieval
     make install

     # compile executable
     make

     # OPTIONAL: To test the module, use this as input
     make debug
     sudo ./main "{echoLeftPin: 24, triggerLeftPin: 23, echoRightPin: 26, triggerRightPin: 25, threshold: 175, distanceDiff: 1.25, debug: false, delay: 750, }"
...
* Basic, Required MagicMirror config.js
  #+BEGIN_SRC js
