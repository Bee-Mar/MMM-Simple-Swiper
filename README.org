...
** Before getting started...
  ...
  5) An image of the pin connections for the HC-SR04 Sensors is our GitHub page

  6) Instructions for the =Required Packages= are from the relevant Github pages

  7) The Required Packages are the _BARE MINIMUM_ to get this working

  8) _NOTE_: Within the =Basic config.js containing required modules=
...
*** MMM-Simple-Swiper
   #+BEGIN_SRC sh
     ...
     cp sample-config-file/SAMPLE_CONFIG.js ~/MagicMirror/config/
